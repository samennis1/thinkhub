            ...
            <div className="container mx-auto px-4 py-4">
              <div className="flex justify-between items-center">
                <div className="flex items-center space-x-2">
                  ...
                  <Link href="/" className="text-2xl font-bold">ThinkBridge</Link>
                </div>
                <nav>
          ...
          <footer className="bg-gray-800 text-white py-8 mt-12">
            <div className="container mx-auto px-4">
              <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                <div>
                  ...
                  <p className="text-gray-400">
                    Collaborative project management platform for teams of all sizes.
                ...
                <div>
                  ...
                  <ul className="space-y-2 text-gray-400">
                    <li className="flex items-center">
                      ...
                      <span>support@thinkbridge.com</span>
                    </li>
                    <li className="flex items-center">
                      <svg xmlns="http://www.w3.org/2000/svg" className="h-5 w-5 mr-2" viewBox="0 0 20 20" fill="currentColor">
              ...
              <div className="border-t border-gray-700 mt-8 pt-6 text-center text-gray-400">
                <p>&copy; {new Date().getFullYear()} ThinkBridge. All rights reserved.</p>
              </div>
            </div>
          </footer>
        </TRPCReactProvider>
